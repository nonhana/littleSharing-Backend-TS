...
CREATE TABLE `article_labels` (
  ...
  `label_name` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_croatian_ci NOT NULL COMMENT '标签名称',
  PRIMARY KEY (`label_id`),
  UNIQUE KEY `lable_id_UNIQUE` (`label_id`),
  UNIQUE KEY `lable_name_UNIQUE` (`label_name`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_croatian_ci;
