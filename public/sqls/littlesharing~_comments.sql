...
CREATE TABLE `comments` (
  ...
  `create_date` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `likes` int NOT NULL DEFAULT '0',
  `user_id` int NOT NULL,
  `response_to_comment_id` int DEFAULT NULL,
  `response_to_user_id` int DEFAULT NULL,
  `comment_level` int NOT NULL,
  `article_id` int NOT NULL,
  PRIMARY KEY (`comment_id`),
  KEY `user_id_comment_idx` (`user_id`),
  CONSTRAINT `user_id_comment` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=103 DEFAULT CHARSET=utf8mb3 COMMENT='存放文章评论的表';
...
UPDATE articles SET comment_num = (
...
UPDATE articles SET comment_num = (
        SELECT COUNT(*) FROM comments WHERE article_id = OLD.article_id
